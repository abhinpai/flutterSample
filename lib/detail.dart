...
class DetailPage extends StatefulWidget {
  ...
  final File _file;
  final String _selectedScanner;

  DetailPage(this._file, this._selectedScanner);
...
class _DetailPageState extends State<DetailPage> {
  ...
  void analyzeLabels() async {
    try {
      var currentLabels;
      if (widget._selectedScanner == TEXT_SCANNER) {
      ...
      } else if (widget._selectedScanner == BARCODE_SCANNER) {
      ...
      } else if (widget._selectedScanner == LABEL_SCANNER) {
      ...
      } else if (widget._selectedScanner == FACE_SCANNER) {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: Text(widget._selectedScanner)
      ),
      body: Column(
        children: <Widget>[
          buildImage(context),
          widget._selectedScanner == TEXT_SCANNER
              ? buildTextList(_currentTextLabels)
              : widget._selectedScanner == BARCODE_SCANNER
                  ? buildBarcodeList<VisionBarcode>(_currentBarcodeLabels)
                  : widget._selectedScanner == FACE_SCANNER
      ...
      child: Container(
        ...
        child: Center(
          child: widget._file == null
              ? Text('No Image Present', style: TextStyle(fontWeight: FontWeight.bold),)
              : FutureBuilder<Size>(
            ...
            builder:
              ...
              if(snapshot.hasData){
                return Container(
                  foregroundDecoration: (widget._selectedScanner == TEXT_SCANNER)
      ...
      child: Container(
        child: ListView.builder(
          ...
          itemBuilder: (context, i){
            ...
            switch(widget._selectedScanner){
...
// This MLKit Dense code is taken from the Google Flutter/MLKit Github Repo
