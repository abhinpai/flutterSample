...
import 'package:mlkit_1/detail.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    final colums = List<Widget>();
    colums.add(buildRowTitle(context, 'Select Scanner Type'));
    colums.add(buildSelectScannerRowWidget(context));
    colums.add(buildRowTitle(context, 'Pick Image'));
    colums.add(buildSelectImageRowWidget(context));
    ...
    try {
      ...
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (context) => DetailPage(file, _selectedScanner)),
      );
    } catch (e) {
